...
% \begin{figure}[h!]
%         \centering
%     \subfigure[Frames position and cross product, the camera is moving up and down ]
%     {
%       \input{Imagenes/centreCross.tex}
%       \label{fig:CentreFrames}
%     }
%     \subfigure[Relative position]
%     {
%       \input{Imagenes/centreXY.tex}
%       \label{fig:XYcentre}
%      }
%           \caption{(a) Cross product between principal lines of a corridor, (b)
...
%   \begin{figure}[!h]
%   \centering
%     \subfigure[Frames position and cross product, the camera is moving from right to left]
%     {
%       \input{Imagenes/LateralCross.tex}
%       \label{fig:lateralFRames}
%     }
%     \subfigure[Relative position]
%     {
%       \input{Imagenes/LateralXY.tex}
%       \label{fig:XYlateral}
%      }
%           \caption{(a) Cross product between principal lines of a corridor, (b)
%           relative position between the cross product and the principal lines }
...
% %  \subsection{plattform and experimental results}
